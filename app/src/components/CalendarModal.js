...
const getStyles = (colors, isDark) =>
    StyleSheet.create({
        ...
        weekDayText: {
            width: (dw - 80) / 7,
            textAlign: 'center',
            color: colors.primary,  // Using primary blue color for week days like in image
            fontSize: 14,
            fontWeight: '500'
        },
        daysGrid: {
        ...
        selectedDayCell: {
            backgroundColor: '#1E40AF', // Dark blue like in image
        },
        dayText: {
            fontSize: 16,
            color: colors.foreground
        ...
        todayText: {
            color: '#94A3B8', // Light blue/grey for non-selected dates as per image style if needed, or keeping it distinct
        }
    });
