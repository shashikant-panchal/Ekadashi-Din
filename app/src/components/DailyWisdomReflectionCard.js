    ...
    return (
        <View style={styles.reflectionCard}>
            <View style={styles.reflectionIconContainer}>
                <Ionicons name="moon-outline" size={24} color={DarkBlue} />
            </View>
            <View style={styles.reflectionContent}>
                <Text style={styles.reflectionTitle}>Evening Reflection</Text>
                <Text style={styles.reflectionDescription}> Evening is the perfect time to reflect on Krishna presence in every moment</Text>
            </View>
        </View>
    );
};
