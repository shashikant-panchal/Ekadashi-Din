    ...
    return (
        <SafeAreaView style={styles.safeArea}>
            <ScrollView contentContainerStyle={styles.scrollViewContent}>
                <TouchableOpacity style={styles.header} onPress={() => navigation.goBack()} style={styles.backButton}>
                    <Feather name="arrow-left" size={24} color="#333" />
                </TouchableOpacity>
                <Text style={styles.headerTitle}>Daily Wisdom</Text>
                <View style={styles.placeholderRight} /> {/* Placeholder to balance header */}
                <Text style={styles.headerSubtitle}>Spiritual teachings for your journey</Text>
                <DailyWisdomReflectionCard />
                <View style={styles.mantraCard}>
                    <View style={styles.mantraHeader}>
                        <View style={styles.mantraIconContainer}>
                            <Entypo style={{ backgroundColor: '#fff' }} name="quote" size={20} color={'grey'} />
                        </View>
                ...
                <View style={styles.bottomCard}>
                    <Ionicons name="heart" size={32} color="#fff" style={styles.bottomCardIcon} />
                    <Text style={styles.bottomCardTitle}>Hare Krishna!</Text>
                    <Text style={styles.bottomCardDescription}>The easiest and most sublime process for understanding the Supreme Personality of Godhead is to hear about Him. </Text>
